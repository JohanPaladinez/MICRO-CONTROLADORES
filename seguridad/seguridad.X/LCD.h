...
#define RS PORTCbits.RC0  /*PIN 0 of PORTC is assigned for register select Pin of LCD*/
#define EN PORTCbits.RC1  /*PIN 1 of PORTC is assigned for enable Pin of LCD */
#define ldata PORTC  /*PORTC(PD4-PD7) is assigned for LCD Data Output*/ 
#define LCD_Port TRISC  /*define macros for PORTC Direction Register*/
    
// Declaraciones de las funciones relacionadas con caracteres especiales
